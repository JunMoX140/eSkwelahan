...
function ModalAddQuiz(props) {
  ...
  return(
    <>
      ...
      <Modal show={stat.openModal === 'default'} onClose={() => stat.setOpenModal(undefined)}>
      {/* <Modal show={props.openModal==="default"} onClose={props.openModal==""}> */}
        ...
        <Modal.Footer>
          <Button onClick={() => stat.setOpenModal(undefined)}>I accept</Button>
          <Button color="gray" onClick={() => stat.setOpenModal(undefined)}>
            Decline
          </Button>
        </Modal.Footer>
      </Modal>
