      ...
      <div className=" container mx-auto w-11/12 max-w-screen-xl p-4 py-6 lg:py-8 bg-dark-bg dark:bg-lm-bg rounded-md">
        <div className="md:flex md:justify-between">
          ...
          <div className=" grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-3">
            <div className=" mr-12">
              <h2 className="mb-6 text-sm font-semibold uppercase text-dark-text  dark:text-lm-text">
                The Team
              </h2>
            ...
            <div className="">
              <h2 className="place-items-center mb-6 text-sm font-semibold uppercase  text-dark-text  dark:text-lm-text">
                Follow us
              </h2>
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <div className=" place-items-start grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2">
                  <li className="mb-4">
                    <a
                      href="https://www.facebook.com/"
                      target="_blank"
                      rel="noreferrer"
                      className="text-gray-500 hover:text-dark-accent dark:hover:text-lm-accent"
                    >
                      <svg
                        className="w-4 h-4"
                        aria-hidden="true"
        ...
        <hr className="my-6 border-lm-accent sm:mx-auto dark:border-dark-accent lg:my-8" />
        <div className=" lg:justify-center md:justify-center  sm:flex sm:items-center sm:justify-center">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2023{" "}
            <Link to={"/"} className="hover:underline">
              <a href="#top">eSkwelahan™</a>
            </Link>
            . All Rights Reserved.
          </span>
        </div>
